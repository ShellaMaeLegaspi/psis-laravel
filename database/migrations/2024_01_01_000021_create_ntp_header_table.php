...
return new class extends Migration
{
    ...
    {
        Schema::connection('sqlsrv')->create('NTP_Header', function (Blueprint $table) {
            $table->integer('NTPHeaderID')->primary()->identity();
            $table->string('NTPControlNo', 50);
    ...
    {
        Schema::connection('sqlsrv')->dropIfExists('NTP_Header');
    }
};
