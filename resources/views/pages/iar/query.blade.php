...
<div class="row page-content-title">
  <div class="col-sm-8">
    <h1>Inspection and Acceptance Report (IAR) / Query</h1>
  </div>
    ...
    <div class="row">
      <div class="col col-sm-4">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="IARNo">
          </div>
        </div>
        <div class="form-group row">
      ...
      <div class="col col-sm-4">
        ...
        <div class="form-group row">
          <label for="" class="col-sm-4 col-form-label">Inspected By:</label>
          <div class="col-sm-8">
            <input type="text" class="form-control criteria search-employee" name="InspectedBy">
            <div class="option-employee inspectedby"></div>
          </div>
        </div>
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <select class="form-control criteria" name="Status" id="">
              ...
              <option value="K">Inspected</option>
    ...
    var spbi = {
      ...
      get: function() {
        ...
        this.$txtCriteria.each(function() {
          ...
          if (this.name == 'InspectedBy') criteria[this.name] = $(this).data('id')
        });
      ...
      open: function() {
        ...
        window.open(base_url + 'iar/' + prep_link + '/IARControlNo/' + $(this).data('controlno'), '_blank');
      },
      ...
      render: function() {
        ...
        for (var i in this.headers) {
          row +=
            '<tr data-controlno="' + this.headers[i].IARControlNo + '">' +
            '<td>' + this.headers[i].IARControlNo + '</td>' +
            '<td>' + this.headers[i].IARNo + '</td>' +
