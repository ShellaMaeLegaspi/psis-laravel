...
<div class="row page-content-title">
  <div class="col-sm-8">
    <h1>Property Transfer Report (PTR) / Query</h1>
  </div>
    ...
    <div class="row">
      <div class="col col-sm-4">
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="PTRControlNo">
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-4 col-form-label">PTR No.:</label>
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="PTRNo">
          </div>
        </div>
        <div class="form-group row">
  ...
  (function() {
    var ptr = {
      ...
      open: function() {
        ...
        window.open('{{ url('ptr') }}/' + prep_link + '/PTRControlNo/' + $(this).data('controlno'), '_blank');
      },
      render: function() {
        var row = '';
        ...
        for (var i in this.headers) {
          row +=
            '<tr data-controlno="' + this.headers[i].PTRControlNo + '">' +
            '<td>' + this.headers[i].PTRControlNo + '</td>' +
            '<td>' + this.headers[i].PTRNo + '</td>' +
