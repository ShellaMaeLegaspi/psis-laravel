...
@section('title', 'PRISUP Preparation')
...
<div class="row">
  <div class="col-sm-12">
    <h1>Property Return and Inspection Slip For Excess or Unserviceable Property/ Preparation</h1>
  </div>
</div>
    ...
    <div class="row">
      <div class="col col-sm-4">
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control" id="control-no" value="{{ $PRISUPControlNo ?? '' }}" disabled>
          </div>
        </div>
        <div class="form-group row">
    ...
    <table id="item-table" class="table table-bordered table-striped" width="100%" cellspacing="0" style="font-size: 12px;">
      <thead>
        <tr style="background-color: #B3B6B7;">
          ...
          <th class="col">Qty</th>
          <th class="col">Disposition</th>
          <th class="col">Accountable Officer</th>
          <th class="col">PAR No.</th>
...
@push('scripts')
<script type="text/javascript" src="{{ asset('js/prisup_prep.js') }}?v={{ time() }}"></script>
@endpush
@endsection
