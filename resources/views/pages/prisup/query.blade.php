...
<div class="row page-content-title">
  <div class="col-sm-8">
    <h1>Property Return and Inspection Slip For Excess or Unserviceable Property (PRISUP) / Query</h1>
  </div>
    ...
    <div class="row">
      <div class="col col-sm-4">
        <div class="form-group row">
          <label for="" class="col-sm-4 col-form-label">PRISUP Control No.:</label>
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="PRISUPControlNo">
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-4 col-form-label">PRISUP No.:</label>
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="PRISUPNo">
          </div>
        </div>
      </div>
      <div class="col col-sm-4">
  ...
  (function() {
    var spbi = {
      ...
      open: function() {
        ...
        window.open('{{ url('/property/prisup_') }}' + prep_link + '/PRISUPControlNo/' + $(this).data('controlno'), '_blank');
      },
      render: function() {
        var row = '';
        ...
        for (var i in this.headers) {
          row +=
            '<tr data-controlno="' + this.headers[i].PRISUPControlNo + '">' +
            '<td>' + this.headers[i].PRISUPControlNo + '</td>' +
            '<td>' + this.headers[i].PRISUPNo + '</td>' +
            '<td>' + this.headers[i].DivCode + '</td>' +
