...
<div class="row page-content-title">
  <div class="col-sm-8">
    <h1>Notice of Award (NOA) / Query</h1>
  </div>
  ...
  (function() {
    var spbi = {
      ...
      open: function() {
        ...
        window.open(base_url + 'noa/' + prep_link + '/NOAControlNo/' + $(this).data('controlno'), '_blank');
      },
      render: function() {
        var row = '';
        ...
        for (var i in this.headers) {
          ...
          row +=
            '<tr data-controlno="' + this.headers[i].NOAControlNo + '" >' +
            '<td>' + this.headers[i].NOAControlNo + '</td>' +
