...
<div class="row page-content-title">
  <div class="col-sm-8">
    <h1>Property Acknowledgement Receipt (PAR) / Query</h1>
  </div>
    ...
    <div class="row">
      <div class="col col-sm-4">
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="PARControlNo">
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-4 col-form-label">PAR No.:</label>
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="PARNo">
          </div>
        </div>
        <div class="form-group row">
  ...
  (function() {
    ...
    var spbi = {
      ...
      open: function() {
        ...
        window.open(base_url + 'par/' + prep_link + '/PARControlNo/' + $(this).data('controlno'), '_blank');
      },
      ...
      render: function() {
        ...
        for (var i in this.headers) {
          if(parcontrol.hasOwnProperty(this.headers[i].PARControlNo)){

            
          }else{
            row +=
            '<tr data-controlno="' + this.headers[i].PARControlNo + '">' +
            '<td>' + this.headers[i].PARControlNo + '</td>' +
            '<td>' + this.headers[i].PARNo + '</td>' +
            ...
            parcontrol[this.headers[i].PARControlNo] = this.headers[i].PARControlNo;
          }
