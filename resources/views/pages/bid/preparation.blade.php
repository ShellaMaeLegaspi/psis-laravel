...
<style type="text/css">
  ...
  #tbl-utilization th, #tbl-utilization-header th {
    width: 20% !important;
  }
...
<div class="row page-content-title">
  <div class="col-sm-12">
    <h1>Bid Doc (Technical Specs) / Preparation</h1>
  </div>
</div>

@if(session('EmployeeID') == '25-1010')
  <button id="btn-edit" class="btn btn-danger pull-left" value="{{ $BidControlNo ?? '' }}">Edit</button>
@endif
        ...
        <div class="row">
          <div class="col col-sm-4">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" id="control-no" value="{{ $BidControlNo ?? '' }}" disabled>
              </div>
            </div>
            <div class="form-group row">
...
<script type="text/javascript" src="{{ asset('js/bid_prep.js') }}?v={{ time() }}"></script>
@endpush
@endsection
