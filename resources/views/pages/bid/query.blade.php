...
<div class="row page-content-title">
  <div class="col-sm-8">
    <h1>Bid Doc (Technical Specs) / Query</h1>
  </div>
    ...
    <div class="row">
      <div class="col col-sm-4">
        <div class="form-group row">
          <label for="" class="col-sm-4 col-form-label">Bid Doc Control No.:</label>
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="BidControlNo">
          </div>
        </div>
        <div class="form-group row">
      ...
      <div class="col col-sm-4">
        ...
        <div class="form-group row">
          <label for="" class="col-sm-3 col-form-label">Tracking No.:</label>
          <div class="col-sm-9">
  ...
  (function() {
    var query = {
      ...
      open: function() {
        ...
        window.open(base_url + 'bid/' + prep_link + '/BidControlNo/' + $(this).data('controlno'), '_blank');
      },
      render: function() {
        var row = '';
        ...
        for (var i in this.headers) {
          ...
          row +=
            '<tr data-controlno="' + this.headers[i].BidControlNo + '">' +
            '<td>' + this.headers[i].BidControlNo + '</td>' +
