...
<div class="row page-content-title">
  <div class="col-sm-8">
    <h1>Notice to Proceed (NTP) / Query</h1>
  </div>
    ...
    <div class="row">
      <div class="col col-sm-4">
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="NTPControlNo">
          </div>
        </div>
        <div class="form-group row">
  ...
  (function() {
    var spbi = {
      ...
      open: function() {
        ...
        window.open(base_url + 'ntp/' + prep_link + '/NTPControlNo/' + $(this).data('controlno'), '_blank');
      },
      render: function() {
        var row = '';
        ...
        for (var i in this.headers) {
          ...
          row +=
            '<tr data-controlno="' + this.headers[i].NTPControlNo + '">' +
            '<td>' + this.headers[i].NTPControlNo + '</td>' +
