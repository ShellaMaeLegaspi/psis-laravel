...
<div class="row page-content-title">
  <div class="col-sm-8">
    <h1>Purchase Request (PR) / Query</h1>
  </div>
    ...
    <div class="row">
      <div class="col col-sm-4">
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="PRControlNo">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="PPMPYear">
          </div>
        </div>
        <div class="form-group row">
      ...
      <div class="col col-sm-4">
        ...
        <div class="form-group row">
          <label for="" class="col-sm-4 col-form-label">Evaluated By:</label>
          <div class="col-sm-8">
            <input type="text" class="form-control criteria search-employee" name="EvaluatedBy">
            <div class="option-employee evaluatedby"></div>
          </div>
        </div>
        <div class="form-group row">
      ...
      <div class="col col-sm-4">
        ...
        <div class="form-group row">
          <label for="" class="col-sm-2 col-form-label">Tracking No.:</label>
          <div class="col-sm-4">
    ...
    var spbi = {
      ...
      get: function() {
        ...
        this.$txtCriteria.each(function() {
          ...
          if (this.name == 'EvaluatedBy') criteria[this.name] = $(this).data('id')
      ...
      open: function() {
        ...
        window.open('{{ url('/pr/') }}' + prep_link + '/PRControlNo/' + $(this).data('controlno'), '_blank');
      },
      render: function() {
        var row = '';
        ...
        for (var i in this.headers) {
          ...
          row +=
            '<tr data-controlno="' + this.headers[i].PRControlNo + '">' +
            '<td>' + this.headers[i].PRControlNo + '</td>' +
