...
<div class="row page-content-title">
  <div class="col-sm-8">
    <h1>Requisition and Issuance Slip (RIS) / Query</h1>
  </div>
    ...
    <div class="row">
      <div class="col col-sm-4">
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="RISControlNo">
          </div>
        </div>
        <div class="form-group row">
          <label for="" class="col-sm-4 col-form-label">RIS No.:</label>
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="RISNo">
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-8">
            <input type="text" class="form-control criteria" name="Purpsoe">
          </div>
        </div>
      </div>
      <div class="col col-sm-4">
  ...
  (function() {
    var spbi = {
      ...
      open: function() {
        ...
        window.open(base_url + 'ris/' + prep_link + '/RISControlNo/' + $(this).data('controlno'), '_blank');
      },
      ...
      render: function() {
        ...
        for (var i in this.headers) {
          row +=
            '<tr data-controlno="' + this.headers[i].RISControlNo + '">' +
            '<td>' + this.headers[i].RISControlNo + '</td>' +
